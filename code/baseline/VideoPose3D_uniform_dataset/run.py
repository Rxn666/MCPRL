...
for subject in dataset.subjects():
    ...
    for action in dataset[subject].keys():
        ...
        for cam_idx in range(len(keypoints[subject][action])):
            # print(len(keypoints[subject][action]))
...
print(poses_valid_2d[0].shape[-2])  # num_joints_in
print(poses_valid_2d[0].shape[-1])  # in_features
print(dataset.skeleton().num_joints())  # num_joints_out
print(filter_widths)
    ...
    while epoch < args.epochs:
        ...
        if semi_supervised:
            ...
            for _, batch_3d, batch_2d in train_generator.next_epoch():
                ...
                # print("inputs_2d shape: ", inputs_2d.shape, type(inputs_2d))
                # print("predicted_3d_pos shape: ", predicted_3d_pos.shape, type(predicted_3d_pos))
...
if args.render:
    ...
    def run_evaluation(actions, action_filter=None):
        ...
        print("errors_p1.shape: ", len(errors_p1))
        print("errors_p2.shape: ", len(errors_p2))
        print("errors_p3.shape: ", len(errors_p3))
        print("Velocity. shape: ", len(errors_vel))
