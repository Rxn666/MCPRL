    ...
    for i, data in enumerate(tqdm(dataLoader, 0)):
        ...
        if split == 'train':
            ...
            if opt.MAE:
                ...
                print("action_error_sum ", action_error_sum)
                ...
                # print(joint_error_test)
                # print(pred_out.squeeze(1).shape)
                # print(out_target.squeeze(1).shape)
                joint_error_test_p2 = p_mpjpe(pred_out.squeeze(1), out_target.squeeze(1)).mean()
                # print(joint_error_test_p2)
                out = pred_out
                # if opt.refine:
                #     post_out[:, :, 14, :] = 0
...
if __name__ == '__main__':
    ...
    model['trans'] = nn.DataParallel(TemporalModel(17, 2, 17, filter_widths, causal=opt.causal, dropout=opt.dropout,
                                               channels=opt.channels)).cuda()
