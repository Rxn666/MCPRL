...
def parse_args():
    ...
    # General arguments
    parser.add_argument('-d', '--dataset', default='mpii', type=str, metavar='NAME', help='target dataset') # h36m or humaneva
    parser.add_argument('-k', '--keypoints', default='gt', type=str, metavar='NAME', help='2D detections to use')
    parser.add_argument('-str', '--subjects-train', default='S200,S201,S202,S203,S204,S205,S206,S207,S208,S209,S210,S211,S212,S213,S214,S215', type=str, metavar='LIST', help='training subjects separated by comma')
    parser.add_argument('-ste', '--subjects-test', default='S216,S217,S218,S219,S220,S221', type=str, metavar='LIST', help='test subjects separated by comma')
    ...
    parser.add_argument('-coeff-kept', '--number-of-kept-coeffs', default='3', type=int, metavar='N', help='how many coefficients are kept')
